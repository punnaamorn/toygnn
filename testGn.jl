...
# ╔═╡ c49bcf15-9dd8-4f38-8257-1135b20ca961
begin
	using Pkg
	using Graphs
	...
	function verProp(smiles)
		...
		dsVer = DataStore(atomicNumber = (atom_number(mol)),
					   ...
					   hybridization = (hybridization(mol)))
		return dsVer
	end
	...
	smiles = "O=C1CCCCCN1"
	println(graphProp(smiles))
	println(verProp(smiles))
	println(edgeProp(smiles))
...
manifest_format = "2.0"
project_hash = "210754bd29589cf9b0099a88b2cd5ae61985d4af"
...
[[deps.GNNGraphs]]
deps = ["ChainRulesCore", "Functors", "Graphs", "KrylovKit", "LinearAlgebra", "MLDataDevices", "MLDatasets", "MLUtils", "NNlib", "NearestNeighbors", "Random", "SparseArrays", "Statistics", "StatsBase"]
...
git-tree-sha1 = "3d859acc11decae2446ee65bf2f77b6bdef8fe56"
...
deps = ["ChainRulesCore", "ConcreteStructs", "Flux", "GNNGraphs", "GNNlib", "LinearAlgebra", "MLUtils", "MacroTools", "NNlib", "Random", "Reexport", "Statistics"]
git-tree-sha1 = "600f8a14ea5b0c618c389396c176110a9a55c1de"
...
[[deps.MolecularGraph]]
deps = ["Base64", "Colors", "Dates", "DelimitedFiles", "GeometryBasics", "Graphs", "JSON", "LinearAlgebra", "MakieCore", "OrderedCollections", "Printf", "Statistics", "YAML", "coordgenlibs_jll", "libinchi_jll"]
git-tree-sha1 = "19b06710c69d8c4be09dd78c7a99459268718695"
